...
export default function HomePage() {
    ...
    const handleMIDINote = useCallback((event: MIDINoteEvent) => {
        ...
        // Note: Sight Reading doesn't use timing evaluation currently,
        // but we preserve compensated timestamp for future timing-based features
        const eventTimestamp = event.compensatedTimestamp || event.timestamp;
